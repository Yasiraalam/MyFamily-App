...
import com.yasir.myfamily.ui.fragments.HomeFragment
import com.yasir.myfamily.ui.fragments.MapsFragment
import com.yasir.myfamily.ui.fragments.ProfileFragment
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.bottomBar.setOnItemSelectedListener {
            when(it.itemId){
                ...
                R.id.nav_guard -> inflateFragment(GuardFragment())
                R.id.nav_profile -> inflateFragment(ProfileFragment())
            }
            true
        }
            ...
            object : LocationCallback() {
                override fun onLocationResult(locationResult: LocationResult) {
                    ...
                    for (location in locationResult.locations) {
                        Log.d("Location02", "onLocationResult: latitude ${location.latitude}")
                        Log.d("Location02", "onLocationResult: longitude ${location.longitude}")
